...
(define number "+33630829000")
(define spaced_number "+33 6 30 82 90 00")
...
(define title "PhD Candidate in Computer Science")

(define subtitle "Research topics: federated learning, artificial intelligence, peer-to-peer networks")
